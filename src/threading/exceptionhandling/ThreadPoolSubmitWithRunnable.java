 ...
 */
public class ThreadPoolSubmitWithRunnable {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            if (i != 3)
                results.add(service.submit(new SampleThread("Thread "+i)));
            else
                results.add(service.submit(new SampleThreadThrowingException("Thread "+i)));
        }
        service.shutdown();
